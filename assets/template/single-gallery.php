...
get_gallery_slider($post->ID,$type);
                ...
                <div class="row postLists">
                    ...
                    <div class="article_wrapper post clearfix">
                        <div class="meta">
                            ...
                            ?><span class="inline-block"><i class="fas fa-user"></i><?php echo get_the_author();
                                ?> · <?php the_time('n月j日 · Y年') ?></span><?php do_action('pf-post-meta-before-tag');
                            ?><?php
                            if (get_the_term_list($post->ID, 'gallery-tag')) {
                                ?><span class="inline-block"><i class="fas fa-tag"></i><?php
                                    $the_tags = apply_filters('the_tags', get_the_term_list($post->ID, 'gallery-tag', '', ' · ', ''), '', ' · ', '', $post->ID);
